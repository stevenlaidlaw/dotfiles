...
alias wsau='ws && export AGW_region=au'
alias wsus='ws && export AGW_region=us'
alias wsnz='ws && export AGW_region=nz'
alias wsca='ws && export AGW_region=ca'
...
alias agnz='wsnz && ags'
alias agca='wsca && ags'
alias agcau='wsau && agc'
alias agcus='wsus && agc'
alias agcnz='wsnz && agc'
alias agcca='wsca && agc'
alias agwau='wsau && agw'
alias agwus='wsus && agw'
alias agwnz='wsnz && agw'
alias agwca='wsca && agw'
alias agcompile='wsau && be rails assets:precompile'
